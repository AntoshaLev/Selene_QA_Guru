...
class RegistrationPage:
    ...
    def upload_a_picture(self, value):
        browser.element('#uploadPicture').should(be.visible).type(resourses.path(value))
    ...
    def student_should_by_registred(self, full_name, email, gender, phone_number, date_of_birth, subject, hobby,
                                    picture, state, city):
